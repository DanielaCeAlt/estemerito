...
async function POST(request) {
    try {
        ...
        const usuarios = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])('SELECT * FROM Usuarios WHERE Correo = ? AND Estatus = 1', [
            correo
        ]);
        ...
        if (usuario.Contraseña.startsWith('$2b$')) {
            isValidPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(contraseña, usuario.Contraseña);
        } else {
        ...
        const nivelUsuario = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])('SELECT NivelUsuario FROM nivelusuarios WHERE idNivelUsuario = ?', [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8afcb862._.js.map